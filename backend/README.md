...
## Project Structure
    ...
    ├── testapiautosetting_124850  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124850`
...
2. Clone this repo and `cd testapiautosetting_124850`
